...
theme_bump <- function() {
  ...
  theme_bw(base_size = 15) +
    ...
    theme(plot.title = element_text(color = color_text, size = 18.5, face = "bold", hjust = 0.5)) +
    ...
    theme(axis.text.x.top = element_markdown(size = 8.3, color = "#3b3b3a")) +
    theme(axis.text.y = element_blank()) +
    # theme(strip.text = element_text(face = "bold")) +
    theme(plot.tag = element_markdown(size = 8, color = "black")) +
    theme(plot.tag.position = c(0.10, 0.882)) +
