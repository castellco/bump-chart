...
theme_bump <- function() {
  ...
  theme_bw(base_size = 15) +
    ...
    theme(axis.text.x = element_markdown(size = 13, vjust = 0.5, hjust = 0.5, color = color_text)) +
...
ggplot(
  ...
  scale_x_discrete(limits = x_names_ordered, , labels = x_names_full, position = "top", expand = expansion(mult = c(0.35, 0.1))) +
  labs(
